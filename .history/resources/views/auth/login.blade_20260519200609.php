...
<body class="bg-[#F0E6C8] min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
    ...
    <div class="bg-white/75 backdrop-blur-xl rounded-3xl shadow-xl flex w-full max-w-[450px] overflow-hidden relative z-10">
        <div class="absolute left-10 top-1/2 -translate-y-1/2 z-20">
    <h1 class="text-[40px] font-extrabold text-[#1a1a1a] leading-tight">
        ThriftStop
    </h1>
    <p class="text-[14px] text-[#444] mt-2 max-w-[220px]">
        Find your style, save your money, and express yourself with thrift fashion.
    </p>
</div>
