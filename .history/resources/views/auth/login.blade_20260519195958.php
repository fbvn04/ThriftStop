...
<body class="bg-[#F0E6C8] min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
    ...
    <div class="absolute left-0 top-0 h-full w-[40%] overflow-hidden">
        <img
            src="{{ asset('images/thrift-login.png') }}"
            alt="ThriftStop Fashion"
            class="w-full h-full object-contain object-top opacity-60 scale-110 -translate-y-6"
        >
    </div>

    {{-- ✅ LOGIN CARD (TETAP STRUKTUR AWAL) --}}
    <div class="bg-white/75 backdrop-blur-xl rounded-3xl shadow-xl flex w-full max-w-[450px] overflow-hidden relative z-10">

        {{-- ❌ BAGIAN GAMBAR DALAM CARD SUDAH DIHAPUS --}}
