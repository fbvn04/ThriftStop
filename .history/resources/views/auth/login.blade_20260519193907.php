...
<body class="min-h-screen flex flex-col relative">
    ...
    <div class="absolute inset-0 z-0">
        ...
        >
        {{-- Overlay supaya tidak terlalu terang --}}
        <div class="absolute inset-0 bg-[#F0E6C8]/60"></div>
    </div>
    ...
    <div class="relative z-10 flex-1 flex items-center justify-center px-4 py-16">
        ...
        {{-- Login Card --}}
        <div class="bg-white/75 backdrop-blur-xl rounded-3xl shadow-xl flex w-full max-w-[620px] overflow-hidden">

            {{-- Kiri: Branding --}}
            <div class="w-[42%] flex flex-col items-start justify-center px-8 py-10 border-r border-[#d1c4a8]">
                <h1 class="text-[32px] font-extrabold leading-none">
