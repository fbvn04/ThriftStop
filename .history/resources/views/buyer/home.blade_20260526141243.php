<x-layout-buyer :user="auth()->user()" titlePage="Beranda">
    ...
    @push('styles')
        <style>
            ...
            /* ── Kategori strip full width ── */
            /*
                 * Kita "break out" dari padding <main> dengan negative margin,
                 * lalu beri padding inline sendiri supaya konten tetap sejajar.
                 * Ini membuat strip memanjang sampai pojok kanan layar.
                 */
            .kategori-section {
                /* keluar dari padding main (5 / lg:7 = 20px / 28px) */
                margin-left: -20px;
                margin-right: -20px;
                margin-bottom: 24px;
                padding: 0 20px;
    ...
    <div class="hero-wrap" id="heroSlider">
        ...
        <div class="hero-slide">
            ...
            <div class="hero-content">
                <span class="hero-tag">Produk Berkualitas</span>
                <div class="hero-title">Fashion <span>Thrift</span><br>Berkualitas</div>
                <a href="{{ route('buyer.shop') }}" class="hero-btn">
                    Lihat Produk <i class="fa-solid fa-arrow-right text-[11px]"></i>
                </a>
            </div>
        </div>
        <div class="hero-slide">
