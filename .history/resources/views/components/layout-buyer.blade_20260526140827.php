    ...
    <style>
        * {
        ...
        body {
            margin: 0;
            padding: 0;
            /* TIDAK pakai height:100% — biarkan halaman scroll alami */
        }
        ...
        /* #mainWrap mengisi sisa lebar, scroll normal lewat halaman */
        #mainWrap {
            flex: 1;
            margin-left: 220px;
            display: flex;
            flex-direction: column;
            min-height: 100vh;
            /* supaya footer tetap ke bawah meski konten pendek */
        ...
        /* main TIDAK overflow-y:auto → scroll lewat window biasa */
        main {
            flex: 1;
        }
        ...
        /* ── Footer — di bawah konten, scroll alami ── */
        footer {
            background: #fff;
            border-top: 1px solid #f0e9d8;
            padding: 36px 36px 24px;
            /* TIDAK fixed / sticky — ikut flow halaman */
        }
...
<body>
    ...
    <aside id="sidebar">
        ...
        {{-- Profile — jarak lebih dari logo --}}
        <div class="mx-3 mb-4 mt-4 rounded-xl bg-[#F1E0B4]/60 p-3 flex items-center gap-3 profile-wrap flex-shrink-0">
    ...
    <div id="mainWrap">
        {{-- Header sticky — search memanjang full --}}
        <header
            class="sticky top-0 z-20 bg-white/90 backdrop-blur-md shadow-sm px-5 lg:px-8 py-3 flex items-center gap-3 flex-shrink-0">
            <button onclick="openSidebar()"
                class="lg:hidden text-[#555] hover:text-[#FF5500] transition-colors flex-shrink-0">
                <i class="fa-solid fa-bars text-[18px]"></i>
            </button>

            <div class="relative flex-1" id="searchArea">
        ...
        {{-- Main content — scroll lewat window, bukan overflow-y:auto --}}
        <main class="p-5 lg:p-7 space-y-6">
            {{ $slot }}
        </main>

        {{-- Footer — ikut flow normal halaman, muncul saat di-scroll ke bawah --}}
        <footer>
            <div class="footer-inner">
                <div>
                    ...
                    <p class="footer-desc">
                        ThriftStop adalah platform thrift fashion terpercaya di Indonesia. Kami menghubungkan penjual
                        dan pembeli produk fashion berkualitas dengan harga terjangkau, mendorong gaya hidup
                        berkelanjutan — satu pakaian dalam satu waktu.
                    </p>
                    <a href="{{ route('buyer.about') }}" class="footer-about-link">
                ...
                <div>
                    ...
                    <div class="footer-info-item">
                        ...
                        <a href="mailto:support@thriftstop.id">support@thriftstop.id</a>
                    </div>
                    <div class="footer-info-item">
                    ...
                    <div class="footer-info-item">
                        ...
                        <span>Jl. Sudirman No. 12, Jakarta Pusat, DKI Jakarta 10220</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="footer-info-item">
                        ...
                        <div>
                            <div class="font-semibold text-[#1a1a1a] text-[12px]">Senin – Jumat</div>
                    ...
                    <div class="footer-info-item">
                        <i class="fa-regular fa-clock"></i>
                        <div>
                            <div class="font-semibold text-[#1a1a1a] text-[12px]">Sabtu</div>
                            <div>09.00 – 15.00 WIB</div>
                        </div>
                    </div>
                    <div class="footer-info-item">
                        <i class="fa-solid fa-circle-xmark" style="color:#d1d5db"></i>
                        <div>
                            <div class="font-semibold text-[#1a1a1a] text-[12px]">Minggu & Libur Nasional</div>
                            <div>Tutup</div>
                        </div>
                    </div>
                </div>
