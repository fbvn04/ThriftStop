...
<head>
    ...
    <style>
        * {
        ...
        header {
            /* extend to full width of mainWrap */
        }
...
<body>
    ...
    <aside id="sidebar">
        ...
        {{-- Profile — diberi margin top lebih besar supaya tidak terlalu dekat logo --}}
    ...
    <div id="mainWrap">
        {{-- Header: search bar memanjang penuh sampai pojok kanan --}}
        <header
            ...
            {{-- Search + Filter — flex-1 supaya makan sisa ruang --}}
            ...
            {{-- Notif + Keranjang: tetap di kanan, tidak flex-shrink --}}
        ...
        {{-- Footer (muncul setelah scroll, bukan di fixed) --}}
        <footer>
            <div class="footer-inner">
                ...
                <div>
                    ...
                    <div class="footer-info-item">
                        <i class="fa-solid fa-circle-xmark" style="color:#e5e7eb"></i>
                        <div>
