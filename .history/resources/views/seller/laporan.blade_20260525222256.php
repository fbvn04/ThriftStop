...
<head>
    ...
    <title>Laporan Penjualan – ThriftStop</title>
...
<body>
        ...
        <main class="flex-1 p-5 lg:p-7 space-y-5 overflow-y-auto">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-sub" id="statRatingSub"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="section-card">
                <div class="section-header">
                    <span class="section-title"><i class="fa-solid fa-chart-line text-[#FF5500] mr-2"></i>Grafik
                        Pendapatan</span>
            ...
            <!-- Two col: Top Produk + Ringkasan Kategori -->
            <div class="two-col">
                <!-- Top Produk -->
                <div class="section-card">
                    <div class="section-header">
                        <span class="section-title"><i class="fa-solid fa-trophy text-[#FF5500] mr-2"></i>Produk
                            Terlaris</span>
                    </div>
                ...
                <div class="section-card">
                    <div class="section-header">
                        <span class="section-title"><i class="fa-solid fa-chart-pie text-[#FF5500] mr-2"></i>Per
                            Kategori</span>
                    </div>
            ...
            <div class="section-card">
                <div class="section-header">
                    <span class="section-title"><i class="fa-solid fa-receipt text-[#FF5500] mr-2"></i>Riwayat
                        Transaksi</span>
                    <span style="font-size:11px;color:#aaa;">Data simulasi</span>
                </div>
    ...
    <script>
        ...
        const TRANSAKSI = [
            { id: '#TS-0041', produk: 'Nike 1990 Windbreaker', pembeli: 'Ahmad R.', tgl: '24 Mei 2025', total: 'Rp 175.000', status: 'sukses' },
            { id: '#TS-0040', produk: 'Levi\'s 501 Original', pembeli: 'Siti M.', tgl: '24 Mei 2025', total: 'Rp 120.000', status: 'sukses' },
            { id: '#TS-0039', produk: 'ZAFUL Alaska Sweatshirt', pembeli: 'Budi S.', tgl: '23 Mei 2025', total: 'Rp 130.000', status: 'proses' },
            { id: '#TS-0038', produk: 'Stone Island Jacket', pembeli: 'Rina K.', tgl: '23 Mei 2025', total: 'Rp 210.000', status: 'sukses' },
            { id: '#TS-0037', produk: 'Flannel Shirt Vintage', pembeli: 'Doni P.', tgl: '22 Mei 2025', total: 'Rp 85.000', status: 'batal' },
            { id: '#TS-0036', produk: 'Nike 1990 Windbreaker', pembeli: 'Lina A.', tgl: '22 Mei 2025', total: 'Rp 175.000', status: 'sukses' },
            { id: '#TS-0035', produk: 'Levi\'s 501 Original', pembeli: 'Hendra T.', tgl: '21 Mei 2025', total: 'Rp 120.000', status: 'proses' },
        ];
        ...
        function updateStats(period) {
            ...
            document.getElementById('statRating').textContent = '4.8 / 5.0';
            document.getElementById('statRatingSub').textContent = '★★★★★ dari 89 ulasan';
        }
        ...
        function renderTopProduk() {
            ...
            list.innerHTML = TOP_PRODUK.map((p, i) => `
        ...
        function renderTabel() {
            const labelMap = { sukses: 'Selesai', proses: 'Diproses', batal: 'Dibatalkan' };
            const tbody = document.getElementById('tabelTransaksi');
            tbody.innerHTML = TRANSAKSI.map(t => `
            <tr>
                <td style="font-size:11.5px;font-weight:600;color:#FF5500;">${t.id}</td>
                <td style="font-weight:500;">${t.produk}</td>
                <td style="color:#888;">${t.pembeli}</td>
                <td style="color:#aaa;font-size:11.5px;">${t.tgl}</td>
                <td style="font-weight:700;color:#1a1a1a;">${t.total}</td>
                <td><span class="badge-status ${t.status}">${labelMap[t.status]}</span></td>
            </tr>
        `).join('');
        }
