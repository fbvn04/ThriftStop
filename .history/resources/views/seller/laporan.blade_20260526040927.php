...
<body>
        ...
        <main class="flex-1 p-5 lg:p-7 space-y-5 overflow-y-auto">
            ...
            <div style="display:grid; grid-template-columns: 1fr 300px; gap:14px;" class="rekap-grid">
                ...
                <div class="section-card" style="display:flex; flex-direction:column;">
                    ...
                    <div class="pay-list" style="flex:1;">
                        ...
                        <div class="pay-item">
                            ...
                            <div class="pay-bar-wrap">
                                ...
                                <div class="pay-bar-bg">
                                    <div class="pay-bar wallet" style="width:7%"></div>
                                </div>
                            </div>
                    ...
                    <!-- Insight teks -->
                    <div
                        style="margin:14px 16px; padding:12px 14px; background:#fff8f5; border-radius:12px; border:1px solid #ffe4d6;">
                        <p style="font-size:10.5px; color:#FF5500; font-weight:700; margin:0 0 4px;">
                            <i class="fa-solid fa-lightbulb mr-1"></i>Insight
                        </p>
                        <p style="font-size:11px; color:#666; margin:0; line-height:1.6;">
                            Mayoritas pembeli pakai <strong>QRIS</strong>. Pastikan QR selalu aktif & tampil di toko
                            untuk konversi optimal.
                        </p>
                    </div>
                    <!-- Mini chart donut -->
                    <div style="padding:0 16px 16px;">
                        <div style="position:relative; height:130px;">
                            <canvas id="chartPay" role="img" aria-label="Donut chart distribusi metode pembayaran">QRIS
                                52%, Transfer Bank 28%, COD 13%, E-Wallet 7%</canvas>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        // ── Data Rekap ──
        // Setiap bulan: { income, order, item, itemLalu (tahun lalu), status }
        const REKAP = {
            2025: [
        ...
        (function () {
            ...
            new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: ['QRIS', 'Transfer Bank', 'COD', 'E-Wallet'],
                    datasets: [{
                        data: [52, 28, 13, 7],
                        backgroundColor: ['#FF5500', '#3b82f6', '#22c55e', '#a855f7'],
                    ...
                    plugins: {
                        legend: {
                            ...
                            labels: {
                                ...
                                color: '#888', padding: 8, boxWidth: 8, boxHeight: 8,
                            }
                        },
                        tooltip: {
