...
<head>
    ...
    <title>ThriftStop Seller – Kelola Produk</title>
...
<body>
    ...
    <div id="mainWrap">
        ...
        <main class="flex-1 p-5 lg:p-7 space-y-5 overflow-y-auto">
                ...
                <div style="position:relative;">
                    ...
                    <div class="filter-dropdown" id="filterDropdown" style="display:none;">
                        ...
                        <div class="filter-chip-row">
                            ...
                            <button class="filter-chip" onclick="toggleChip(this,'stok','Hampir Habis')">Hampir
                                Habis</button>
            ...
            <div style="display:flex;gap:10px;flex-wrap:wrap;">
                <div
                    style="background:#fff;border-radius:12px;padding:12px 18px;display:flex;align-items:center;gap:10px;box-shadow:0 1px 6px rgba(0,0,0,.05);">
                    <div
                        style="width:34px;height:34px;border-radius:9px;background:#FFF3EC;display:flex;align-items:center;justify-content:center;">
                        <i class="fa-solid fa-boxes-stacked" style="color:#FF5500;font-size:14px;"></i>
                    </div>
                    <div>
                        <p style="font-size:10px;color:#aaa;margin:0;font-weight:500;">Total Produk</p>
                        <p style="font-size:18px;font-weight:700;color:#1a1a1a;margin:0;">{{ $totalProduk }}</p>
                    </div>
                </div>
                <div
                    style="background:#fff;border-radius:12px;padding:12px 18px;display:flex;align-items:center;gap:10px;box-shadow:0 1px 6px rgba(0,0,0,.05);">
                    <div
                        style="width:34px;height:34px;border-radius:9px;background:#f0fdf4;display:flex;align-items:center;justify-content:center;">
                        <i class="fa-solid fa-circle-check" style="color:#10b981;font-size:14px;"></i>
                    </div>
                    <div>
                        <p style="font-size:10px;color:#aaa;margin:0;font-weight:500;">Stok Tersedia</p>
                        <p style="font-size:18px;font-weight:700;color:#1a1a1a;margin:0;">{{ $stokTersedia }}</p>
                    </div>
                </div>
                <div
                    style="background:#fff;border-radius:12px;padding:12px 18px;display:flex;align-items:center;gap:10px;box-shadow:0 1px 6px rgba(0,0,0,.05);">
                    <div
                        style="width:34px;height:34px;border-radius:9px;background:#fffbeb;display:flex;align-items:center;justify-content:center;">
                        <i class="fa-solid fa-triangle-exclamation" style="color:#f59e0b;font-size:14px;"></i>
                    </div>
                    <div>
                        <p style="font-size:10px;color:#aaa;margin:0;font-weight:500;">Hampir Habis</p>
                        <p style="font-size:18px;font-weight:700;color:#1a1a1a;margin:0;">{{ $hampirHabis }}</p>
                    </div>
                </div>
            </div>
            ...
            @if($produks->isEmpty())
                <div class="empty-state">
                    <i class="fa-solid fa-box-open"
                        style="font-size:48px;color:#e0d5c0;display:block;margin-bottom:14px;"></i>
                    <p style="font-size:14px;font-weight:600;color:#bbb;margin-bottom:6px;">Belum ada produk</p>
                    <p style="font-size:13px;color:#ccc;margin:0;">Klik "Tambah Produk" untuk menambahkan produk pertamamu
                    </p>
                </div>
            @else
                <div class="product-grid" id="productGrid">
                    @foreach($produks as $produk)
                        <div class="product-card" data-id="{{ $produk->id }}" data-nama="{{ $produk->nama_produk }}"
                            ...
                            data-stok="{{ $produk->stok }}" onclick="bukaDetailProduk({{ $produk->id }})">
    ...
    {{-- ── MODAL DETAIL PRODUK (diisi via JS/fetch) ── --}}
    ...
    <script>
        ...
        // ── Filter (client-side, untuk UX cepat)
        ...
        // ── Detail Modal (fetch JSON dari controller)
