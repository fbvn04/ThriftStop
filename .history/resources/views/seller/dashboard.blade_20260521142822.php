...
<head>
    ...
    <title>Dashboard - ThriftStop Seller</title>
    ...
    <aside id="sidebar">
        ...
        <div class="p-4 border-t border-[#f0e9d8] flex-shrink-0">
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="logout-btn w-full flex items-center gap-2.5 justify-center py-2.5 px-4 rounded-lg
    ...
    <div id="mainWrap">
        ...
        <main class="flex-1 p-5 lg:p-7 space-y-5 overflow-y-auto">
            ...
            <div class="welcome-card">
                ...
                <div class="absolute right-0 bottom-0 h-full flex items-end pointer-events-none select-none overflow-hidden"
                    style="border-radius: 0 20px 20px 0;">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 160" class="h-[145px] lg:h-[168px] w-auto"
                        fill="none">
                        <!-- Tanaman kiri -->
                        <ellipse cx="30" cy="148" rx="18" ry="8" fill="#e65c00" opacity=".35" />
                        <path d="M30 148 Q18 120 22 100 Q26 80 30 110 Q34 80 38 100 Q42 120 30 148Z" fill="#fff"
                            opacity=".25" />
                        <path d="M30 148 Q14 125 10 105 Q8 90 20 105 Q16 88 24 98 Q28 82 30 108Z" fill="#fff"
                            opacity=".18" />
                        <!-- Pot tanaman -->
                        <rect x="20" y="144" width="20" height="12" rx="3" fill="#fff" opacity=".3" />
                        <!-- Tanaman kanan belakang -->
                        <ellipse cx="165" cy="150" rx="16" ry="7" fill="#e65c00" opacity=".3" />
                        <path d="M165 150 Q155 128 158 110 Q162 92 165 118 Q168 92 172 110 Q175 128 165 150Z"
                            fill="#fff" opacity=".2" />
                        <rect x="157" y="146" width="16" height="10" rx="3" fill="#fff" opacity=".25" />
                        <!-- Kursi / sofa kecil -->
                        <rect x="60" y="115" width="90" height="35" rx="10" fill="#fff" opacity=".22" />
                        <rect x="55" y="108" width="12" height="42" rx="6" fill="#fff" opacity=".18" />
                        <rect x="143" y="108" width="12" height="42" rx="6" fill="#fff" opacity=".18" />
                        <rect x="58" y="108" width="94" height="14" rx="7" fill="#fff" opacity=".18" />
                        <!-- Badan orang -->
                        <ellipse cx="105" cy="126" rx="18" ry="20" fill="#FF8C00" />
                        <!-- Kerah/baju -->
                        <path d="M90 130 Q105 140 120 130 L122 150 Q105 158 88 150Z" fill="#FF6B00" />
                        <!-- Kepala -->
                        <circle cx="105" cy="100" r="16" fill="#FDBCB4" />
                        <!-- Rambut / hijab style orange -->
                        <path d="M89 100 Q89 82 105 80 Q121 82 121 100 Q121 88 105 87 Q89 88 89 100Z" fill="#FF5500" />
                        <!-- Kerudung menutupi bahu -->
                        <path d="M86 104 Q88 95 105 93 Q122 95 124 104 Q118 118 105 120 Q92 118 86 104Z"
                            fill="#FF5500" />
                        <!-- Wajah -->
                        <ellipse cx="100" cy="102" rx="2" ry="2.5" fill="#e8856e" />
                        <ellipse cx="110" cy="102" rx="2" ry="2.5" fill="#e8856e" />
                        <path d="M101 108 Q105 111 109 108" stroke="#e8856e" stroke-width="1.5" stroke-linecap="round"
                            fill="none" />
                        <!-- Tangan kiri pegang buku -->
                        <path d="M88 128 Q80 130 76 138 Q78 142 84 140 Q88 136 90 132Z" fill="#FDBCB4" />
                        <!-- Tangan kanan nulis -->
                        <path d="M122 128 Q130 126 136 130 Q138 136 134 140 Q128 138 124 134Z" fill="#FDBCB4" />
                        <!-- Buku / clipboard -->
                        <rect x="72" y="132" width="30" height="22" rx="3" fill="#fff" opacity=".9" />
                        <line x1="77" y1="138" x2="97" y2="138" stroke="#FF5500" stroke-width="1.2" opacity=".5" />
                        <line x1="77" y1="143" x2="97" y2="143" stroke="#FF5500" stroke-width="1.2" opacity=".5" />
                        <line x1="77" y1="148" x2="90" y2="148" stroke="#FF5500" stroke-width="1.2" opacity=".5" />
                        <!-- Pulpen -->
                        <rect x="132" y="128" width="3" height="14" rx="1.5" fill="#fff" opacity=".9"
                            transform="rotate(-20 132 128)" />
                    </svg>
                </div>
                <!-- Bubbles dekoratif -->
