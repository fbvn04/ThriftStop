<x-layout-seller titlePage="Kelola Toko Saya">
    <form action="{{ route('seller.toko.edit') }}"
          method="POST"
          enctype="multipart/form-data"
          class="px-10 py-1.5 scale-x-100 w-full h-fit bg-white rounded-lg
          md:px-14 md:py-10">
            @if($errors->any())
        ...
        <div class="my-5 px-10 w-full flex flex-col items-center gap-y-8
            ...
            <div class="w-full flex flex-col items-center">
                ...
                <button type="button" id="uploadProfile" class="cursor-pointer mt-5 py-1.5 px-5 rounded-sm bg-[#FF5500]">
                ...
                <div class="flex flex-col gap-y-3.5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="username"
                            type="text"
                            value="{{ $dataToko->user->username }}"
                            placeholder="Masukkan username baru"
                            class="w-full font-light rounded-sm border border-gray-300 px-3 py-2 text-sm outline-none transition
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Masukkan nama baru toko anda"
                            class="w-full font-light rounded-sm border border-gray-300 px-3 py-2 text-sm outline-none transition
                            md:text-md md:rounded-lg md:font-normalmd:py-1">
                    ...
                    <div>
                        ...
                        <div id="phoneField" class="w-4/5 flex items-center rounded-lg border border-gray-300 py-1 text-sm transition">
                            <span class="text-sm text-gray-600 px-3 border-r-2 border-gray-400">+62</span>
                            <input
                                id="phoneInput"
                                name="hp"
                                type="text"
                                value="{{ $dataToko->user->hp }}"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="email"
                            type="text"
                            value="{{ $dataToko->user->email }}"
                            placeholder="Contoh : Rahandika@gmail.com"
                            class="w-full font-light rounded-sm border border-gray-300 px-3 py-2 text-sm outline-none transition
                            md:text-md md:rounded-lg md:font-normalmd:py-1">
        ...
        <div class=" flex flex-col gap-y-10">
            ...
            <div>
                ...
                <textarea
                    ...
                    name="deskripsi_toko"
                    placeholder="Masukkan nama baru toko anda"
                    class="w-full h-40 resize-none overflow-auto rounded-lg border border-gray-300 px-3 py-1 text-sm outline-none transition"
                ></textarea>
            </div>
